...
# Generation Time: 2013-07-05 19:41:17 +0800
# ************************************************************
...
VALUES
	...
	(2,'Second Announcement!','First Flight\n\nIn this momentous occasion, we see two baby common goldeneye ducks leaving the nest and taking to the air for their first ever flight. The expressions on their face are priceless!\n\n(c) World\'s Fact\'s\n\n- Wolfgang Amadeus Ravaged Yellow Kings - Trivia Mania\n\nPls Vote for us! \nYELLOW RAVAGED KINGS\nhttps://www.facebook.com/questions/565496953489562/','2013-06-05 23:03:13',1);
...
INSERT INTO `comment_tb` (`id`, `announcement_id`, `comment`, `created_date`, `created_by`)
VALUES
	(1,2,'First Comment','2013-06-08 23:30:33',1),
	(2,2,'Long COmment \n\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specime','2013-06-08 23:44:34',2);

/*!40000 ALTER TABLE `comment_tb` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table contractor_city_tb
# ------------------------------------------------------------

DROP TABLE IF EXISTS `contractor_city_tb`;

CREATE TABLE `contractor_city_tb` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `contractor_city_tb` WRITE;
/*!40000 ALTER TABLE `contractor_city_tb` DISABLE KEYS */;

INSERT INTO `contractor_city_tb` (`id`, `user_id`, `city_id`)
VALUES
	(1,3,1),
	(2,5,3);

/*!40000 ALTER TABLE `contractor_city_tb` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(4,8,2,'2013-06-09 00:12:42','0','Ms.','Rilley','Santos','Cortez','Something something in quezon city ave',1,'1968-11-22','rcortez@yahoo.com','','','','',1),
	(5,3,1,'2013-06-09 19:36:41','0','Mr.','John Paul','Cruz','Smith','Bonifacio Global Center',1,'1980-06-23','bgcimba@bgc.com','','','','Near Serendra',1),
	(6,11,1,'2013-06-11 23:07:18','1','Mrs.','Camille','Austin','Faustino','Novaliches TV5',0,'1977-01-22','c.austin@hotmail.com','2568910','','09062349930','near tv5',1),
	(7,9,1,'2013-06-12 17:32:04','0','Ms.','Eufrancia','De dios','Ramos','Baisa St. Calooocan city',1,'1978-08-15','','','','','',1);
...
INSERT INTO `schedule_tb` (`id`, `schedule`)
VALUES
	(1,'8:00 am - 10');
...
VALUES
	...
	(5,'con1','912ec803b2ce49e4a541068d495ab570','Contract','one','One','conone@gmail.com','12345',5);
