...
$(document).ready(function(){
            ...
            success: function(response){
                ...
                $.each(time, function(index, value){
                    ...
                    if(dd > today && sched.id == ""){
                        ...
                        "<button type='button' class='save-schedule btn btn-primary btn-small'>Reschedule to this schedule</button></ul>";
                    }
    ...
    $("#schedules").delegate(".save-schedule", 'click', function(){
        ...
        $.ajax({
            type: "POST",
            url: "Tickets/submit_reschedule",
            async: false,
            data: {
                dispatchId: <?php echo $dispatch->id; ?>,
                time: time,
                date: date,
            },
            success: function(response){
...
<?php
    ...
    echo "<h4>" . date('F d, Y H:i:s A', strtotime($dispatch->timeStart)) . "</h4>";
